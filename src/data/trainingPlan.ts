...

  {
    ...
    days:[
      ...
      {day:'Sat',session:{type:'compromised',workoutType:'complete',format:'4 Rounds',
        ...
        notes:'Race-order compromised running into your weak stations. Seamless changeovers — dead time at the swap is time lost. Watch pace drift rounds 3–4.',
...

  {
    ...
    days:[
      ...
      {day:'Thu',session:{type:'strength',workoutType:'power',format:'Legs + Power + Weak Stations',
        ...
        detail:'A) Back Squat 5×5 (heavy) · B) Power Clean 5×3 · C) RDL 3×8 · D) Calf Raise 4×18 · Then: 5 rounds of 28 Wall Balls + 25m Lunges + 14 Burpee BJ (75s rest)',
        notes:'Heaviest squats yet — build the leg strength that powers the sled and lunges. Then five weak-station rounds. Wall-ball count creeping up — chase unbroken sets.',
...

  {
    ...
    days:[
      ...
      {day:'Tue',session:{type:'run',workoutType:'engine',format:'6 × 800m',
        ...
        detail:'2km warm-up · 6 × 800m at 4:05–4:10/km · 90s recovery · 2km cooldown',
        notes:'Z4. Six reps at race pace off tired legs. This is the landmark speed session — hold every split.'}},
      {day:'Wed',session:{type:'rest',title:'Rest',duration:'',detail:'Full rest. 8+ hrs sleep.',notes:''}},
      {day:'Thu',session:{type:'strength',workoutType:'power',format:'Legs + Explosive + Weak Stations',
        title:'Explosive Legs + Weak Stations',duration:'68 min',
        detail:'A) Back Squat 4×5 (peak load) · B) Power Clean 5×3 + Box Jump 5×5 · C) Calf Raise 4×20 · Then: 6 rounds of 33 Wall Balls + 25m Lunges + 15 Burpee BJ (60s rest)',
        notes:'Peak weak-station volume. If wall balls are unbroken here, they’ll be unbroken on race day. This is your proof session.',
      ...
      {day:'Sat',session:{type:'sim',workoutType:'complete',format:'Race Order',
        ...
        notes:'Back half of the race, full loads. Lunges and wall balls are your stations — this is the exact fatigue you’ll feel on race day. Wall balls unbroken, farmers unbroken.',
...

  {
    ...
    days:[
      ...
      {day:'Sat',session:{type:'sim',workoutType:'complete',format:'6-Station Sim',
        ...
        notes:'Compare run splits round to round — hold pace on round 3. This is a dress rehearsal for your weak stations under race fatigue.',
...

  {
    ...
    days:[
      ...
      {day:'Sat',session:{type:'sim',workoutType:'complete',format:'Full Race',
        ...
        notes:'Dress rehearsal. Full race protocol — pre-race nutrition, warm-up, kit on. If possible do it at a Hyrox gym on the real machines. This tells you exactly where you stand.',
